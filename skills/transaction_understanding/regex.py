...
def match_regex_patterns(
    ...
    patterns = [
        ...
        (r"AMAZON", "Amazon", "Expense", "Shopping", "General"),
        ...
        (r"ZOMATO|SWIGGY|FOODPANDA", "Food Delivery", "Expense", "Food", "Restaurant"),
        ...
        (r"FLIPKART|MYNTRA|MEESHO", "E-commerce", "Expense", "Shopping", "General"),
